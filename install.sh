...
# uninstall docker, then Install docker using the apt repository https://docs.docker.com/engine/install/debian/#uninstall-docker-engine
...
docker -v #Docker version 28.0.1, build 068a01e
